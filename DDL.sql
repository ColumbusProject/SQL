...
(
  itinearay_number INT          NOT NULL DEFAULT AUTO_INCREMENT COMMENT '게시물 번호',
...
(
  review_number  INT         NOT NULL DEFAULT AUTO INCREMENT COMMENT '게시물 번호',
  writer_id      VARCHAR(50) NOT NULL COMMENT '작성자 아이디',
...
(
  travel_trade_number INT          NOT NULL DEFAULT AUTO_INCREMENT COMMENT '게시물 번호',
